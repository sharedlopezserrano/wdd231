...
document.addEventListener("DOMContentLoaded", () => {
  ...
  `;
  main.insertBefore(viewToggle, main.querySelector(".directory-grid"));
      ...
      if (view === "grid") {
        ...
        card.innerHTML = `
          <div class="business-img">
            ${member.image ? `<img src="${member.image}" alt="${member.name} logo" loading="lazy" style="width:100%;height:100%;object-fit:contain;">` : ""}
          </div>
